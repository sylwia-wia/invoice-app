    ...
    <table class="table mt-4">
        ...
        @foreach ($contractors as $contractor)
            ...
            <tr>
                ...
                <td class="row g-2">
                    <form method="POST" action="{{ route('contractor.destroy', [$contractor->id]) }}" class="col-auto">
                        @csrf
                    ...
                    <form method="POST" action="{{ route('contractor.edit', [$contractor->id]) }}" class="col-auto">
                        @csrf
                        <button class="btn btn-white">
